...
- Safe fail-closed behavior: if WhatsApp returns an unusual sender ID and the bot cannot verify that participant in group metadata, it ignores the message instead of risking a wrong kick.
- IDs in `IGNORED_PARTICIPANT_IDS` are fully ignored. Default: `58090154115181@lid`.
